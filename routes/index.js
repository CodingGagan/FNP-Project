...
router.post("/coustomer", upload.single("image"), (req, res) => {
  ...
  // console.log("post received:%s %s", firstname)
...
router.post('/addorder', function(req,res,next){
  ...
  // console.log("post received: %s", pincode)
})
...
router.get("/fetch-producttypes/",(req,res) => {
  let qry = `SELECT * FROM filtertype WHERE filtersubcategory = '${req.query.filtersubcategoryId}'`;
  // console.log(qry)
  mysql.query(qry,(err,result) =>{
    if (err)
    throw err
